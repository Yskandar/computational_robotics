...
# First: Let us see what happens when you change the position of the obstacles and run the dynamics update
...
for i in range(num_iterations):
    ...
    obstacles_idx = np.random.choice(len(world.states), num_obstacles)
    print(obstacles_idx)
    print(world.states)
    obstacles = [world.states[idx] for idx in obstacles_idx]
